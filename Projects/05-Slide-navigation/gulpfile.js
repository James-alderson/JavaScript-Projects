...
// Gulp default task
exports.default = series(parallel(css_task, js_task), Cachebust_task, copyCss_task, copyImage_task, copyIcon_task, watch_task)

// Run browserSync
exports.bs = series(parallel(css_task, js_task), Cachebust_task, copyCss_task, copyImage_task, copyIcon_task, browserSync, browserSyncWatch)
